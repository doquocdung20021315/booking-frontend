    ...
    <div className="confirm-container">
      <div className="confirm-box">
          ...
          <div>
            <div className="confirm-profile-row">
              ...
              <div className="confirm-profile-cell">
                ...
                <span className="confirm-profile-info">Giới tính: {account.gender === "M" ? "Nam" : "Nữ"}</span>
              </div>
            </div>
            <div className="confirm-profile-row">
              <div className="confirm-profile-cell">
        ...
        <div className="confirm-row">
          <Card className="confirm-facility-card">
          ...
          <Card>
            <div className="confirm-datetime">
              ...
              <div>
                ...
                <div className="confirm-datetime-content">{location.state.time} ngày {selectDate.format("DD-MM-YYYY")}</div>
              </div>
            </div>
          </Card>
        </div>
